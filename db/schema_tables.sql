...
CREATE TABLE card_social_db.user (
  ...
  notes1 VARCHAR(200) NULL,
  notes2 VARCHAR(200) NULL,
  notes3 VARCHAR(200) NULL,
  PRIMARY KEY (id));
...
CREATE TABLE card_social_db.card (
  ...
  show_notes1 BOOLEAN NOT NULL,
  show_notes2 BOOLEAN NOT NULL,
  show_notes3 BOOLEAN NOT NULL,
  extra_notes BOOLEAN NOT NULL,
  PRIMARY KEY (id),
